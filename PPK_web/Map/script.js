...
const Placecoords = {
  ...
  //GATE
  "ประตู:1" : {minlat:19.171383644475274,maxlat:19.17160483615968,minlon:99.90839297185319,maxlon:99.90863601199567},
  "ประตู:2" : {minlat:19.169293413944185,maxlat:19.169522507446985,minlon:99.90829670659004,maxlon:99.9085261059367},
  "ประตู:3" : {minlat:19.168823046841904,maxlat:19.16900812786088,minlon:99.90866945016411,maxlon:99.9088630058628},
  "ประตู:4" : {minlat:19.16878602936797,maxlat:19.168907912040474,minlon:99.90963838604914,maxlon:99.90976622839328},  
  "ประตู:5" : {minlat:19.16942176749237,maxlat:19.169517379766997,minlon:99.91065114846361,maxlon:99.91078552528431},
  "ประตู:6" : {minlat:19.170451580738895,maxlat:19.170508658952244,minlon:99.91076932789329,maxlon:99.91091579207678},  
  "ประตู:7" : {minlat:19.171107896195583,maxlat:19.171247236395246,minlon:99.91078766893676,maxlon:99.91099218737307} 
}
...
//GATE-----------------------------------------------------------------------------------------------------
    ...
    case "ประตู:1":
      return [
        "ประตูหลักของโรงเรียน",
        "อยู่ข้างอาคาร 1",
        "หากประตูอื่นปิดสามารถออกทางประตู 1 ได้"
      ]

    case "ประตู:2":
      return [
        "ประตูบริเวณขอบสนามกีฬา ติดกับถนนหลัก",
        "เข้า-ออก ได้เฉพาะทางเท้าเท่านั้น",
        "ส่วนมากจะจอดบริเวณนี้"
      ]

    case "ประตู:3":
      return [
        "ประตูติดกับถนนหลัก",
        "เข้า-ออก ผ่านรถยนต์ และจักรยานยนต์"
      ]

    case "ประตู:4":
      return [
        "ประตูด้านล่างของโรงเรียน",
        "ผ่านได้ เฉพาะจักรยานยนต์ และทางเท้า"
      ]

    case "ประตู:5":
      return [
        "ประตูหลังอาคาร 6",
        "ยังไม่สามารถเข้า-ออก ผ่านประตูนี้ได้"
      ]

    case "ประตู:6":
      return [
        "ประตูหลังอาคาร 4",
        "ประตูที่ติดกับ โรงอาหาร เหมาะสำหรับซื้อข้าวเช้าทันที"
      ]

    case "ประตู:7":
      return [
        "ประตูหลังอาคาร 5",
        "ผ่านสำหรับรถยนต์ และจักรยานยนต์"
      ]
